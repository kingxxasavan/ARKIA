...
- **Draft + preview workflow:** admin edits (sites, categories, page text) are kept as a **local draft** and are *not* live until you press **Push live**. A bar shows when you have unpublished changes, with **Preview** (see the page exactly as visitors do) and **Discard**. Because nothing reaches Firestore until you push, a broken edit can't take down the live site; if a push fails, your draft is kept. The draft survives a page reload.
